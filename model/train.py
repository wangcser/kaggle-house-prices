...
# model
from model.regression_model import BaseModel, AveragingModels, StackingAveragedModels


def main():
    # 1. base model cv-test.
    models = BaseModel()
    models.base_model_score()

    # 2. average model test.
    ...
    print("stacked average model train rmsle:", stacked_averaged_models.rmsle(models.y_train, stacked_train_pred))
